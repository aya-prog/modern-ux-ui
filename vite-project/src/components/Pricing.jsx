          ...
          {plans.map((plan, key) => (
            <div
              ...
              className={`relative bg-slate-900/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full ${
                plan.mostPopular
                  ? "border-pink-500 shadow-2xl shadow-pink-500/20 lg:scale-105"
            ...
            >
              ...
              {plan.mostPopular && (
                <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="flex items-center space-x-1 px-3 sm:px-4 py-1 sm:py-1.5 bg-gradient-to-b from-pink-500 to-rose-500 rounded-full text-xs sm:text-sm font-semibold shadow-lg">
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <div className="flex items-baseline justify-center">
                  <span
                    className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text 
                  text-transparent"
                  >
                    ${plan.price}
                  </span>
                ...
                {plan.features.map((feature, featureKey) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-pink-500/20 flex items-center justify-center mt-0.5">
                      <Check className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-pink-400" />
                    </div>
